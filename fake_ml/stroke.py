...
class StrokeService:
    def __init__(self):
        self.stroke = pd.read_csv('../../pythonProject/static/data/dam/ml/healthcare-dataset-stroke-data.csv')
        self.my_stroke = None
        self.df1 = None
        self.cols = None
        self.cols1 = None
    ...
    def additional_process(self):
        ...
        print(" ### 프리프로세스 종료 ### ")
        self.stroke.to_csv("../../../static/save/dam/ml/stroke.csvstroke.csv")

    def sampling(self):
        df = pd.read_csv("../../pythonProject/static/save/dam/ml/stroke.csv")
