...
from src.utl.lambdas import MosaicLambdas
...
def Haar(*params):
    #image = params[0]
    #xml = params[1]
    haar = cv.CascadeClassifier('../../../static/data/dam/mosaic/' + params[1])
...
def Mosaics(img, size):
    haar = cv.CascadeClassifier('../../../static/data/dam/mosaic/haarcascade_frontalface_alt.xml')
...
class MenuController(object):
    ...
    def menu_5(*params):
        ...
        cv.imwrite('../../../static/data/dam/mosaic/cat-mosaic.png', mos)
